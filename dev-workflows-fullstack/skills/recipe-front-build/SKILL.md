...
1. **Agent tool** (subagent_type: "dev-workflows-fullstack:task-executor-frontend") → Record the current HEAD as `diffBase`, pass the task file path in the prompt, and receive the structured response
